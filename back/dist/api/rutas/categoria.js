...
exports.categoria_router.put('/categoria/:id', categoria_1.updateCategoria);
exports.categoria_router.delete('/categoria/:id', categoria_1.categoria_controller.deleteById);
